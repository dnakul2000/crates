    ...
    def _on_file_done(self, index: int, stems: dict):
        ...
        if stems:
            ...
            for stem_type, path in stems.items():
                ...
                preview_parts.append(f"  {stem_type}/{p.name}  ({size:.1f} MB)")
